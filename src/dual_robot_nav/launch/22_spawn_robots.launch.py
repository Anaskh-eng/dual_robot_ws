...
def generate_launch_description():
    ...
    args = [
        DeclareLaunchArgument('tb3_1_x',   default_value='-1'),
        DeclareLaunchArgument('tb3_1_y',   default_value='-3'),
        DeclareLaunchArgument('tb3_1_yaw', default_value='1.57'),
        DeclareLaunchArgument('tb3_2_x',   default_value='1'),
        DeclareLaunchArgument('tb3_2_y',   default_value='-3.0'),
