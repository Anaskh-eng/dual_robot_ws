...
def generate_launch_description():
    ...
    nav_tb3_1 = _nav2_group('TB3_1', params_tb3_1, map_yaml, rviz_tb3_1, rviz_enabled, '-1.0', '-3.5', '1.57')
    nav_tb3_2 = TimerAction(
        period=5.0,
        actions=[_nav2_group('TB3_2', params_tb3_2, map_yaml, rviz_tb3_2, rviz_enabled, '1.0', '-3.5', '1.57')]
    )
