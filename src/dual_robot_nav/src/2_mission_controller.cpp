...
void MissionController::executeDemoMission()
{
  ...
  // Loading Docks
  const Waypoint loading_dock_TB3_1  = {"Loading Dock TB3_1",    -3.8,  0.5, 0.0};
  const Waypoint loading_dock_TB3_2  = {"Loading Dock TB3_2",     -3.8,  -0.5, 0.0};
  
  // Machines for TB3_1
  const Waypoint machine_M1 = {"Machine M1", -0.5, 2.0, 0.0};
  const Waypoint machine_M2 = {"Machine M2",  3.5, 2.0, 0.0};
  
  // Machines for TB3_2
  const Waypoint machine_M3 = {"Machine M3",  3.5, -2.0, 0.0};
  const Waypoint machine_M4 = {"Machine M4",  -0.5, -2.0, 0.0};
